...
<nav className="bg-white dark:bg-gray-900/90 fixed w-full z-20 top-0 start-0 shadow-2xl backdrop-blur-md">
  ...
  <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">FitEasy</span>
  </a>
  <div class="flex items-center md:gap-3  md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" className="text-white hover:bg-fitness focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-slate-800 dark:hover:bg-fitness dark:focus:ring-blue-800 mr-10 transition">Entrar</button>
      <button type="button" className="text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center bg-fitness dark:hover:bg-fitness-600 dark:focus:ring-blue-800 ">Login</button>
      <button onClick={toggleTheme} className="text-fitness hidden md:flex text-xl rounded-full hover:bg-slate-200/30 p-3 transition"  ><FaMoon /></button>
