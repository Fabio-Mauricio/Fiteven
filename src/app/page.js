...
export default function Home() {
  return (
   ...
   <div className="flex items-center justify-center mt-20 flex flex-col md:p-10 gap-15" >
     <div className="flex flex-col md:flex-row text-center items-center justify-center w-5/6 h-5/6 " >
      ...
      <div className="mt-3 flex flex-col items-center justify-center gap-3 md:flex-row md:gap-7 text-neutral-100">
      ...
      <div className="flex flex-col md:flex-row-reverse md:p-10 text-center items-center justify-center w-5/6 h-5/6 " >
      ...
      <div className="mt-3 flex flex-col items-center justify-center gap-3 md:flex-row md:gap-7">
        <button className="bg-fitness p-2 shadow-lg shadow-emerald-500/40 rounded-md hover:bg-emerald-500 text-neutral-100" >Veja como adquirir o Fitness</button>  
      </div>
      </div>
     </div>
   </div>
   ...
   <div className="text-white p-5 bg-gray-900 flex flex-col gap-3 items-center mt-7" >
     ...
     <div className=" p-5 flex flex-col gap-3 items-center mt-7" >
